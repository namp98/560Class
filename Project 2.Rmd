...
SVM <- mysvm.pred
Discriminant.Analysis <- myrda.pred$class
Decision.tree <- mytree.pred
Random.forest <- myrf.pred
ActualType <- BreastCancer$Class
...
Ensemble.df <-t((rbind(SVM, Neural, Discriminant.Analysis, Decision.tree, Random.forest, Majoritymode, ActualType)))
Ensemble.df
